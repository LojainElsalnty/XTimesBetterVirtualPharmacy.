...
const AppointmentsByStatusViewDoctor = () => {
    ...
    const buildFetchUrl = (chosenStatus) => {
        return `http://localhost:5000/doctor/filterAppointmentsByStatusForDoctor/filterByStatus?status=${chosenStatus}`;
    };
...
export default AppointmentsByStatusViewDoctor;
/*import React, { useState, useEffect } from 'react';
