...
export const PasswordValidation = ({ newPassword }) => {
    ...
    const [passwordUpperCase, setPasswordUpperCase] = useState('password-validation-juppercase-li');
    const [passwordNumber, setPasswordNumber] = useState('password-validation-number-li');
    const [passwordLength, setPasswordLength] = useState('password-validation-length-li');
    ...
    return (
        <div className={styles['password-validation-main-div']}>
            <h3 className={styles['password-validation-title-h3']}>Password hould be:</h3>
