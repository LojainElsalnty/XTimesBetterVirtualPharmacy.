...
import styles from './WalletPharmacistInfo.module.css'; // Import your CSS for styling
...
const ViewPharmacistWalletPage = () => {
    ...
    useEffect(() => {
        const fetchWalletDetails = async () => {
            try {
                const response = await axios.get('http://localhost:8000/pharmacist/viewWalletNumber', {
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': accessToken,
                    },
...
export default ViewPharmacistWalletPage;